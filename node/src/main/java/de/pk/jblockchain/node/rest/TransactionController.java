...
public class TransactionController {
	...
	/**
	 * Add a new Transaction to the pool. It is expected that the transaction
	 * has a valid signature and the correct hash.
	 *
	 * @param transaction
	 ...
	 *            the new Transaction
	 * @param response
	 *            Status Code 202 if Transaction accepted, 406 if verification
	 *            fails
	 */
